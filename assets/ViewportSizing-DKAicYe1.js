var eo=Object.defineProperty;var to=(e,n,t)=>n in e?eo(e,n,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[n]=t;var ye=(e,n,t)=>to(e,typeof n!="symbol"?n+"":n,t);import{aF as Ct,aP as no,aQ as Ht,j as io,h as Ye,aR as ao,aS as je,aT as Ve,aG as St,aU as Bi,m as an,aV as Ti,aW as Hi,aX as wt,ad as Je,r as fn,aY as Vt,H as Ot,aA as At,ae as Mn,V as Ue,aZ as ro,a_ as Tn,U as Dn,az as Jt,a$ as oo,X as Wt,a2 as Ai,b0 as Ze,b1 as so,a1 as Fn,b2 as lo,b3 as Kn,a as it,aE as Bt,b4 as un,b5 as dn,b6 as An,b7 as rn,b8 as co,aD as hr,b9 as on,u as _t,y as bn,ba as fo,aC as $t,bb as Vi,bc as uo,bd as po,be as _n,bf as ho,bg as mo,bh as _o,bi as go,bj as vo,bk as So,bl as Eo,bm as xo,bn as Mo,bo as To,bp as Ao,bq as bo,br as Ro,bs as Co,bt as Do,x as Po,w as _i,s as $n,N as Ln,t as wo,v as tn,bu as Lo,bv as Uo,bw as bi,bx as yo,by as Ri,bz as Io,bA as No,bB as Fo,aj as Ne,P as Go,bC as Oo,bD as Bo,aJ as zt,B as Gn,bE as On,aO as Ho,bF as kt,bG as Sn,bH as Zt,bI as Vo,bJ as mr,bK as _r,bL as gr,bM as Vn,bN as vr,bO as Sr,bP as Er,aM as Ci,bQ as Rn,bR as pn,at as Di,J as Wo,bS as zo,bT as ko,bU as Xo,bV as qo,bW as xr,bX as Yo,bY as Ko,bZ as $o,b_ as Zn,b$ as jn,c0 as Qn,c1 as Jn,c2 as Wi,c3 as zi,c4 as ki,c5 as Xi,c6 as qi,c7 as Yi,c8 as Ki,c9 as $i,ca as Zi,cb as gi,cc as ji,cd as Qi,ce as Ji,cf as ea,cg as ta,ch as na,ci as ia,cj as aa,ck as ra,cl as oa,cm as sa,cn as la,co as ca,cp as fa,cq as ua,cr as da,cs as pa,ct as ha,cu as ma,cv as _a,cw as vi,cx as ga,cy as Zo,cz as jo,cA as Qo,cB as Jo,cC as es,cD as ts,cE as ns,cF as is,cG as va,cH as as,cI as Bn,cJ as rs,cK as Sa,cL as Ea,cM as xa,cN as Mr,aI as os,cO as zn,cP as Ma,cQ as ss,cR as Tr,cS as Si,cT as Ar,cU as ls,cV as br,cW as Rr,cX as Cr,al as Dr,cY as Pr,cZ as wr,c_ as Lr,i as Ur,c$ as Ta,d0 as yr,d1 as ei,d2 as ti,d3 as cs,d4 as fs,d5 as Aa,d6 as xt,d7 as us,d8 as ds,d9 as ps,da as hs,db as ms,dc as _s,a9 as gs,dd as vs,de as Ss,df as Es,aK as xs,n as ni,b as Pt,an as Ms,aB as Ts}from"./three.core-CjlvuMMb.js";import{F as As,b as bs,P as mt,c as Rs,a as Kt,N as It,U as Cs}from"./index-Dyvm9Dhd.js";/**
 * @license
 * Copyright 2010-2026 Three.js Authors
 * SPDX-License-Identifier: MIT
 */function Ir(){let e=null,n=!1,t=null,i=null;function a(o,s){t(o,s),i=e.requestAnimationFrame(a)}return{start:function(){n!==!0&&t!==null&&e!==null&&(i=e.requestAnimationFrame(a),n=!0)},stop:function(){e!==null&&e.cancelAnimationFrame(i),n=!1},setAnimationLoop:function(o){t=o},setContext:function(o){e=o}}}function Ds(e){const n=new WeakMap;function t(d,T){const v=d.array,G=d.usage,R=v.byteLength,h=e.createBuffer();e.bindBuffer(T,h),e.bufferData(T,v,G),d.onUploadCallback();let S;if(v instanceof Float32Array)S=e.FLOAT;else if(typeof Float16Array<"u"&&v instanceof Float16Array)S=e.HALF_FLOAT;else if(v instanceof Uint16Array)d.isFloat16BufferAttribute?S=e.HALF_FLOAT:S=e.UNSIGNED_SHORT;else if(v instanceof Int16Array)S=e.SHORT;else if(v instanceof Uint32Array)S=e.UNSIGNED_INT;else if(v instanceof Int32Array)S=e.INT;else if(v instanceof Int8Array)S=e.BYTE;else if(v instanceof Uint8Array)S=e.UNSIGNED_BYTE;else if(v instanceof Uint8ClampedArray)S=e.UNSIGNED_BYTE;else throw new Error("THREE.WebGLAttributes: Unsupported buffer data format: "+v);return{buffer:h,type:S,bytesPerElement:v.BYTES_PER_ELEMENT,version:d.version,size:R}}function i(d,T,v){const G=T.array,R=T.updateRanges;if(e.bindBuffer(v,d),R.length===0)e.bufferSubData(v,0,G);else{R.sort((S,C)=>S.start-C.start);let h=0;for(let S=1;S<R.length;S++){const C=R[h],B=R[S];B.start<=C.start+C.count+1?C.count=Math.max(C.count,B.start+B.count-C.start):(++h,R[h]=B)}R.length=h+1;for(let S=0,C=R.length;S<C;S++){const B=R[S];e.bufferSubData(v,B.start*G.BYTES_PER_ELEMENT,G,B.start,B.count)}T.clearUpdateRanges()}T.onUploadCallback()}function a(d){return d.isInterleavedBufferAttribute&&(d=d.data),n.get(d)}function o(d){d.isInterleavedBufferAttribute&&(d=d.data);const T=n.get(d);T&&(e.deleteBuffer(T.buffer),n.delete(d))}function s(d,T){if(d.isInterleavedBufferAttribute&&(d=d.data),d.isGLBufferAttribute){const G=n.get(d);(!G||G.version<d.version)&&n.set(d,{buffer:d.buffer,type:d.type,bytesPerElement:d.elementSize,version:d.version});return}const v=n.get(d);if(v===void 0)n.set(d,t(d,T));else if(v.version<d.version){if(v.size!==d.array.byteLength)throw new Error("THREE.WebGLAttributes: The size of the buffer attribute's array buffer does not match the original size. Resizing buffer attributes is not supported.");i(v.buffer,d,T),v.version=d.version}}return{get:a,remove:o,update:s}}var Ps=`#ifdef USE_ALPHAHASH
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:kt,depthTest:!1,depthWrite:!1})}function Ef(e,n,t){const i=new Float32Array(en),a=new Ue(0,1,0);return new zt({name:"SphericalGaussianBlur",defines:{n:en,CUBEUV_TEXEL_WIDTH:1/n,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:i},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:a}},vertexShader:kn(),fragmentShader:`
		...
		`,blending:kt,depthTest:!1,depthWrite:!1})}function Pa(){return new zt({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:kn(),fragmentShader:`
		...
		`,blending:kt,depthTest:!1,depthWrite:!1})}function wa(){return new zt({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:kn(),fragmentShader:`
	...
	`}class Fr extends wt{constructor(n=1,t={}){super(n,n,t),this.isWebGLCubeRenderTarget=!0;const i={width:n,height:n,depth:1},a=[i,i,i,i,i,i];this.texture=new Ar(a),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(n,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;const i={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},a=new Di(5,5,5),o=new zt({name:"CubemapFromEquirect",uniforms:Si(i.uniforms),vertexShader:i.vertexShader,fragmentShader:i.fragmentShader,side:At,blending:kt});o.uniforms.tEquirect.value=t;const s=new Wt(a,o),d=t.minFilter;return t.minFilter===fn&&(t.minFilter=_t),new ls(1,10,this).update(n,s),t.minFilter=d,s.geometry.dispose(),s.material.dispose(),this}clear(n,t=!0,i=!0,a=!0){const o=n.getRenderTarget();for(let s=0;s<6;s++)n.setRenderTarget(this,s),n.clear(t,i,a);n.setRenderTarget(o)}}function xf(e){let n=new WeakMap,t=new WeakMap,i=null;function a(h,S=!1){return h==null?null:S?s(h):o(h)}function o(h){if(h&&h.isTexture){const S=h.mapping;if(S===ei||S===ti)if(n.has(h)){const C=n.get(h).texture;return d(C,h.mapping)}else{const C=h.image;if(C&&C.height>0){const B=new Fr(C.height);return B.fromEquirectangularTexture(e,h),n.set(h,B),h.addEventListener("dispose",v),d(B.texture,h.mapping)}else return null}}return h}function s(h){if(h&&h.isTexture){const S=h.mapping,C=S===ei||S===ti,B=S===Rn||S===pn;if(C||B){let u=t.get(h);const c=u!==void 0?u.texture.pmremVersion:0;if(h.isRenderTargetTexture&&h.pmremVersion!==c)return i===null&&(i=new Ca(e)),u=C?i.fromEquirectangular(h,u):i.fromCubemap(h,u),u.texture.pmremVersion=h.pmremVersion,t.set(h,u),u.texture;if(u!==void 0)return u.texture;{const y=h.image;return C&&y&&y.height>0||B&&y&&T(y)?(i===null&&(i=new Ca(e)),u=C?i.fromEquirectangular(h):i.fromCubemap(h),u.texture.pmremVersion=h.pmremVersion,t.set(h,u),h.addEventListener("dispose",G),u.texture):null}}}return h}function d(h,S){return S===ei?h.mapping=Rn:S===ti&&(h.mapping=pn),h}function T(h){let S=0;const C=6;for(let B=0;B<C;B++)h[B]!==void 0&&S++;return S===C}function v(h){const S=h.target;S.removeEventListener("dispose",v);const C=n.get(S);C!==void 0&&(n.delete(S),C.dispose())}function G(h){const S=h.target;S.removeEventListener("dispose",G);const C=t.get(S);C!==void 0&&(t.delete(S),C.dispose())}function R(){n=new WeakMap,t=new WeakMap,i!==null&&(i.dispose(),i=null)}return{get:a,dispose:R}}function Mf(e){const n={};function t(i){if(n[i]!==void 0)return n[i];const a=e.getExtension(i);return n[i]=a,a}return{has:function(i){return t(i)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(i){const a=t(i);return a===null&&fo("WebGLRenderer: "+i+" extension not supported."),a}}}function Tf(e,n,t,i){const a={},o=new WeakMap;function s(R){const h=R.target;h.index!==null&&n.remove(h.index);for(const C in h.attributes)n.remove(h.attributes[C]);h.removeEventListener("dispose",s),delete a[h.id];const S=o.get(h);S&&(n.remove(S),o.delete(h)),i.releaseStatesOfGeometry(h),h.isInstancedBufferGeometry===!0&&delete h._maxInstanceCount,t.memory.geometries--}function d(R,h){return a[h.id]===!0||(h.addEventListener("dispose",s),a[h.id]=!0,t.memory.geometries++),h}function T(R){const h=R.attributes;for(const S in h)n.update(h[S],e.ARRAY_BUFFER)}function v(R){const h=[],S=R.index,C=R.attributes.position;let B=0;if(C===void 0)return;if(S!==null){const y=S.array;B=S.version;for(let I=0,m=y.length;I<m;I+=3){const A=y[I+0],g=y[I+1],P=y[I+2];h.push(A,g,g,P,P,A)}}else{const y=C.array;B=C.version;for(let I=0,m=y.length/3-1;I<m;I+=3){const A=I+0,g=I+1,P=I+2;h.push(A,g,g,P,P,A)}}const u=new(C.count>=65535?cs:fs)(h,1);u.version=B;const c=o.get(R);c&&n.remove(c),o.set(R,u)}function G(R){const h=o.get(R);if(h){const S=R.index;S!==null&&h.version<S.version&&v(R)}else v(R);return o.get(R)}return{get:d,update:T,getWireframeAttribute:G}}function Af(e,n,t){let i;function a(R){i=R}let o,s;function d(R){o=R.type,s=R.bytesPerElement}function T(R,h){e.drawElements(i,h,o,R*s),t.update(h,i,1)}function v(R,h,S){S!==0&&(e.drawElementsInstanced(i,h,o,R*s,S),t.update(h,i,S))}function G(R,h,S){if(S===0)return;n.get("WEBGL_multi_draw").multiDrawElementsWEBGL(i,h,0,o,R,0,S);let B=0;for(let u=0;u<S;u++)B+=h[u];t.update(B,i,1)}this.setMode=a,this.setIndex=d,this.render=T,this.renderInstances=v,this.renderMultiDraw=G}function bf(e){const n={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function i(o,s,d){switch(t.calls++,s){case e.TRIANGLES:t.triangles+=d*(o/3);break;case e.LINES:t.lines+=d*(o/2);break;case e.LINE_STRIP:t.lines+=d*(o-1);break;case e.LINE_LOOP:t.lines+=d*o;break;case e.POINTS:t.points+=d*o;break;default:je("WebGLInfo: Unknown draw mode:",s);break}}function a(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:n,render:t,programs:null,autoReset:!0,reset:a,update:i}}function Rf(e,n,t){const i=new WeakMap,a=new St;function o(s,d,T){const v=s.morphTargetInfluences,G=d.morphAttributes.position||d.morphAttributes.normal||d.morphAttributes.color,R=G!==void 0?G.length:0;let h=i.get(d);if(h===void 0||h.count!==R){let _=function(){P.dispose(),i.delete(d),d.removeEventListener("dispose",_)};h!==void 0&&h.texture.dispose();const S=d.morphAttributes.position!==void 0,C=d.morphAttributes.normal!==void 0,B=d.morphAttributes.color!==void 0,u=d.morphAttributes.position||[],c=d.morphAttributes.normal||[],y=d.morphAttributes.color||[];let I=0;S===!0&&(I=1),C===!0&&(I=2),B===!0&&(I=3);let m=d.attributes.position.count*I,A=1;m>n.maxTextureSize&&(A=Math.ceil(m/n.maxTextureSize),m=n.maxTextureSize);const g=new Float32Array(m*A*4*R),P=new Mr(g,m,A,R);P.type=Zt,P.needsUpdate=!0;const f=I*4;for(let N=0;N<R;N++){const D=u[N],O=c[N],j=y[N],K=m*A*4*N;for(let z=0;z<D.count;z++){const q=z*f;S===!0&&(a.fromBufferAttribute(D,z),g[K+q+0]=a.x,g[K+q+1]=a.y,g[K+q+2]=a.z,g[K+q+3]=0),C===!0&&(a.fromBufferAttribute(O,z),g[K+q+4]=a.x,g[K+q+5]=a.y,g[K+q+6]=a.z,g[K+q+7]=0),B===!0&&(a.fromBufferAttribute(j,z),g[K+q+8]=a.x,g[K+q+9]=a.y,g[K+q+10]=a.z,g[K+q+11]=j.itemSize===4?a.w:1)}}h={count:R,texture:P,size:new it(m,A)},i.set(d,h),d.addEventListener("dispose",_)}if(s.isInstancedMesh===!0&&s.morphTexture!==null)T.getUniforms().setValue(e,"morphTexture",s.morphTexture,t);else{let S=0;for(let B=0;B<v.length;B++)S+=v[B];const C=d.morphTargetsRelative?1:1-S;T.getUniforms().setValue(e,"morphTargetBaseInfluence",C),T.getUniforms().setValue(e,"morphTargetInfluences",v)}T.getUniforms().setValue(e,"morphTargetsTexture",h.texture,t),T.getUniforms().setValue(e,"morphTargetsTextureSize",h.size)}return{update:o}}function Cf(e,n,t,i,a){let o=new WeakMap;function s(v){const G=a.render.frame,R=v.geometry,h=n.get(v,R);if(o.get(h)!==G&&(n.update(h),o.set(h,G)),v.isInstancedMesh&&(v.hasEventListener("dispose",T)===!1&&v.addEventListener("dispose",T),o.get(v)!==G&&(t.update(v.instanceMatrix,e.ARRAY_BUFFER),v.instanceColor!==null&&t.update(v.instanceColor,e.ARRAY_BUFFER),o.set(v,G))),v.isSkinnedMesh){const S=v.skeleton;o.get(S)!==G&&(S.update(),o.set(S,G))}return h}function d(){o=new WeakMap}function T(v){const G=v.target;G.removeEventListener("dispose",T),i.releaseStatesOfObject(G),t.remove(G.instanceMatrix),G.instanceColor!==null&&t.remove(G.instanceColor)}return{update:s,dispose:d}}const Df={[Lr]:"LINEAR_TONE_MAPPING",[wr]:"REINHARD_TONE_MAPPING",[Pr]:"CINEON_TONE_MAPPING",[Dr]:"ACES_FILMIC_TONE_MAPPING",[Cr]:"AGX_TONE_MAPPING",[Rr]:"NEUTRAL_TONE_MAPPING",[br]:"CUSTOM_TONE_MAPPING"};function Pf(e,n,t,i,a,o){const s=new wt(n,t,{type:e,depthBuffer:a,stencilBuffer:o,samples:i?4:0,depthTexture:a?new Tn(n,t):void 0}),d=new wt(n,t,{type:Vt,depthBuffer:!1,stencilBuffer:!1}),T=new Dn;T.setAttribute("position",new Jt([-1,3,0,-1,-1,0,3,-1,0],3)),T.setAttribute("uv",new Jt([0,2,0,0,2,0],2));const v=new oo({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),G=new Wt(T,v),R=new Ai(-1,1,1,-1,0,1);let h=null,S=null,C=!1,B,u=null,c=[],y=!1;this.setSize=function(I,m){s.setSize(I,m),d.setSize(I,m);for(let A=0;A<c.length;A++){const g=c[A];g.setSize&&g.setSize(I,m)}},this.setEffects=function(I){c=I,y=c.length>0&&c[0].isRenderPass===!0;const m=s.width,A=s.height;for(let g=0;g<c.length;g++){const P=c[g];P.setSize&&P.setSize(m,A)}},this.begin=function(I,m){if(C||I.toneMapping===Ht&&c.length===0)return!1;if(u=m,m!==null){const A=m.width,g=m.height;(s.width!==A||s.height!==g)&&this.setSize(A,g)}return y===!1&&I.setRenderTarget(s),B=I.toneMapping,I.toneMapping=Ht,!0},this.hasRenderPass=function(){return y},this.end=function(I,m){I.toneMapping=B,C=!0;let A=s,g=d;for(let P=0;P<c.length;P++){const f=c[P];if(f.enabled!==!1&&(f.render(I,g,A,m),f.needsSwap!==!1)){const _=A;A=g,g=_}}if(h!==I.outputColorSpace||S!==I.toneMapping){h=I.outputColorSpace,S=I.toneMapping,v.defines={},Je.getTransfer(h)===Ze&&(v.defines.SRGB_TRANSFER="");const P=Df[S];P&&(v.defines[P]=""),v.needsUpdate=!0}v.uniforms.tDiffuse.value=A.texture,I.setRenderTarget(u),I.render(G,R),u=null,C=!1},this.isCompositing=function(){return C},this.dispose=function(){s.depthTexture&&s.depthTexture.dispose(),s.dispose(),d.dispose(),T.dispose(),v.dispose()}}const Gr=new gs,Ei=new Tn(1,1),Or=new Mr,Br=new ds,Hr=new Ar,La=[],Ua=[],ya=new Float32Array(16),Ia=new Float32Array(9),Na=new Float32Array(4);function mn(e,n,t){const i=e[0];if(i<=0||i>0)return e;const a=n*t;let o=La[a];if(o===void 0&&(o=new Float32Array(a),La[a]=o),n!==0){i.toArray(o,0);for(let s=1,d=0;s!==n;++s)d+=t,e[s].toArray(o,d)}return o}function ft(e,n){if(e.length!==n.length)return!1;for(let t=0,i=e.length;t<i;t++)if(e[t]!==n[t])return!1;return!0}function ut(e,n){for(let t=0,i=n.length;t<i;t++)e[t]=n[t]}function Xn(e,n){let t=Ua[n];t===void 0&&(t=new Int32Array(n),Ua[n]=t);for(let i=0;i!==n;++i)t[i]=e.allocateTextureUnit();return t}function wf(e,n){const t=this.cache;t[0]!==n&&(e.uniform1f(this.addr,n),t[0]=n)}function Lf(e,n){const t=this.cache;if(n.x!==void 0)(t[0]!==n.x||t[1]!==n.y)&&(e.uniform2f(this.addr,n.x,n.y),t[0]=n.x,t[1]=n.y);else{if(ft(t,n))return;e.uniform2fv(this.addr,n),ut(t,n)}}function Uf(e,n){const t=this.cache;if(n.x!==void 0)(t[0]!==n.x||t[1]!==n.y||t[2]!==n.z)&&(e.uniform3f(this.addr,n.x,n.y,n.z),t[0]=n.x,t[1]=n.y,t[2]=n.z);else if(n.r!==void 0)(t[0]!==n.r||t[1]!==n.g||t[2]!==n.b)&&(e.uniform3f(this.addr,n.r,n.g,n.b),t[0]=n.r,t[1]=n.g,t[2]=n.b);else{if(ft(t,n))return;e.uniform3fv(this.addr,n),ut(t,n)}}function yf(e,n){const t=this.cache;if(n.x!==void 0)(t[0]!==n.x||t[1]!==n.y||t[2]!==n.z||t[3]!==n.w)&&(e.uniform4f(this.addr,n.x,n.y,n.z,n.w),t[0]=n.x,t[1]=n.y,t[2]=n.z,t[3]=n.w);else{if(ft(t,n))return;e.uniform4fv(this.addr,n),ut(t,n)}}function If(e,n){const t=this.cache,i=n.elements;if(i===void 0){if(ft(t,n))return;e.uniformMatrix2fv(this.addr,!1,n),ut(t,n)}else{if(ft(t,i))return;Na.set(i),e.uniformMatrix2fv(this.addr,!1,Na),ut(t,i)}}function Nf(e,n){const t=this.cache,i=n.elements;if(i===void 0){if(ft(t,n))return;e.uniformMatrix3fv(this.addr,!1,n),ut(t,n)}else{if(ft(t,i))return;Ia.set(i),e.uniformMatrix3fv(this.addr,!1,Ia),ut(t,i)}}function Ff(e,n){const t=this.cache,i=n.elements;if(i===void 0){if(ft(t,n))return;e.uniformMatrix4fv(this.addr,!1,n),ut(t,n)}else{if(ft(t,i))return;ya.set(i),e.uniformMatrix4fv(this.addr,!1,ya),ut(t,i)}}function Gf(e,n){const t=this.cache;t[0]!==n&&(e.uniform1i(this.addr,n),t[0]=n)}function Of(e,n){const t=this.cache;if(n.x!==void 0)(t[0]!==n.x||t[1]!==n.y)&&(e.uniform2i(this.addr,n.x,n.y),t[0]=n.x,t[1]=n.y);else{if(ft(t,n))return;e.uniform2iv(this.addr,n),ut(t,n)}}function Bf(e,n){const t=this.cache;if(n.x!==void 0)(t[0]!==n.x||t[1]!==n.y||t[2]!==n.z)&&(e.uniform3i(this.addr,n.x,n.y,n.z),t[0]=n.x,t[1]=n.y,t[2]=n.z);else{if(ft(t,n))return;e.uniform3iv(this.addr,n),ut(t,n)}}function Hf(e,n){const t=this.cache;if(n.x!==void 0)(t[0]!==n.x||t[1]!==n.y||t[2]!==n.z||t[3]!==n.w)&&(e.uniform4i(this.addr,n.x,n.y,n.z,n.w),t[0]=n.x,t[1]=n.y,t[2]=n.z,t[3]=n.w);else{if(ft(t,n))return;e.uniform4iv(this.addr,n),ut(t,n)}}function Vf(e,n){const t=this.cache;t[0]!==n&&(e.uniform1ui(this.addr,n),t[0]=n)}function Wf(e,n){const t=this.cache;if(n.x!==void 0)(t[0]!==n.x||t[1]!==n.y)&&(e.uniform2ui(this.addr,n.x,n.y),t[0]=n.x,t[1]=n.y);else{if(ft(t,n))return;e.uniform2uiv(this.addr,n),ut(t,n)}}function zf(e,n){const t=this.cache;if(n.x!==void 0)(t[0]!==n.x||t[1]!==n.y||t[2]!==n.z)&&(e.uniform3ui(this.addr,n.x,n.y,n.z),t[0]=n.x,t[1]=n.y,t[2]=n.z);else{if(ft(t,n))return;e.uniform3uiv(this.addr,n),ut(t,n)}}function kf(e,n){const t=this.cache;if(n.x!==void 0)(t[0]!==n.x||t[1]!==n.y||t[2]!==n.z||t[3]!==n.w)&&(e.uniform4ui(this.addr,n.x,n.y,n.z,n.w),t[0]=n.x,t[1]=n.y,t[2]=n.z,t[3]=n.w);else{if(ft(t,n))return;e.uniform4uiv(this.addr,n),ut(t,n)}}function Xf(e,n,t){const i=this.cache,a=t.allocateTextureUnit();i[0]!==a&&(e.uniform1i(this.addr,a),i[0]=a);let o;this.type===e.SAMPLER_2D_SHADOW?(Ei.compareFunction=t.isReversedDepthBuffer()?bi:Ri,o=Ei):o=Gr,t.setTexture2D(n||o,a)}function qf(e,n,t){const i=this.cache,a=t.allocateTextureUnit();i[0]!==a&&(e.uniform1i(this.addr,a),i[0]=a),t.setTexture3D(n||Br,a)}function Yf(e,n,t){const i=this.cache,a=t.allocateTextureUnit();i[0]!==a&&(e.uniform1i(this.addr,a),i[0]=a),t.setTextureCube(n||Hr,a)}function Kf(e,n,t){const i=this.cache,a=t.allocateTextureUnit();i[0]!==a&&(e.uniform1i(this.addr,a),i[0]=a),t.setTexture2DArray(n||Or,a)}function $f(e){switch(e){case 5126:return wf;case 35664:return Lf;case 35665:return Uf;case 35666:return yf;case 35674:return If;case 35675:return Nf;case 35676:return Ff;case 5124:case 35670:return Gf;case 35667:case 35671:return Of;case 35668:case 35672:return Bf;case 35669:case 35673:return Hf;case 5125:return Vf;case 36294:return Wf;case 36295:return zf;case 36296:return kf;case 35678:case 36198:case 36298:case 36306:case 35682:return Xf;case 35679:case 36299:case 36307:return qf;case 35680:case 36300:case 36308:case 36293:return Yf;case 36289:case 36303:case 36311:case 36292:return Kf}}function Zf(e,n){e.uniform1fv(this.addr,n)}function jf(e,n){const t=mn(n,this.size,2);e.uniform2fv(this.addr,t)}function Qf(e,n){const t=mn(n,this.size,3);e.uniform3fv(this.addr,t)}function Jf(e,n){const t=mn(n,this.size,4);e.uniform4fv(this.addr,t)}function eu(e,n){const t=mn(n,this.size,4);e.uniformMatrix2fv(this.addr,!1,t)}function tu(e,n){const t=mn(n,this.size,9);e.uniformMatrix3fv(this.addr,!1,t)}function nu(e,n){const t=mn(n,this.size,16);e.uniformMatrix4fv(this.addr,!1,t)}function iu(e,n){e.uniform1iv(this.addr,n)}function au(e,n){e.uniform2iv(this.addr,n)}function ru(e,n){e.uniform3iv(this.addr,n)}function ou(e,n){e.uniform4iv(this.addr,n)}function su(e,n){e.uniform1uiv(this.addr,n)}function lu(e,n){e.uniform2uiv(this.addr,n)}function cu(e,n){e.uniform3uiv(this.addr,n)}function fu(e,n){e.uniform4uiv(this.addr,n)}function uu(e,n,t){const i=this.cache,a=n.length,o=Xn(t,a);ft(i,o)||(e.uniform1iv(this.addr,o),ut(i,o));let s;this.type===e.SAMPLER_2D_SHADOW?s=Ei:s=Gr;for(let d=0;d!==a;++d)t.setTexture2D(n[d]||s,o[d])}function du(e,n,t){const i=this.cache,a=n.length,o=Xn(t,a);ft(i,o)||(e.uniform1iv(this.addr,o),ut(i,o));for(let s=0;s!==a;++s)t.setTexture3D(n[s]||Br,o[s])}function pu(e,n,t){const i=this.cache,a=n.length,o=Xn(t,a);ft(i,o)||(e.uniform1iv(this.addr,o),ut(i,o));for(let s=0;s!==a;++s)t.setTextureCube(n[s]||Hr,o[s])}function hu(e,n,t){const i=this.cache,a=n.length,o=Xn(t,a);ft(i,o)||(e.uniform1iv(this.addr,o),ut(i,o));for(let s=0;s!==a;++s)t.setTexture2DArray(n[s]||Or,o[s])}function mu(e){switch(e){case 5126:return Zf;case 35664:return jf;case 35665:return Qf;case 35666:return Jf;case 35674:return eu;case 35675:return tu;case 35676:return nu;case 5124:case 35670:return iu;case 35667:case 35671:return au;case 35668:case 35672:return ru;case 35669:case 35673:return ou;case 5125:return su;case 36294:return lu;case 36295:return cu;case 36296:return fu;case 35678:case 36198:case 36298:case 36306:case 35682:return uu;case 35679:case 36299:case 36307:return du;case 35680:case 36300:case 36308:case 36293:return pu;case 36289:case 36303:case 36311:case 36292:return hu}}class _u{constructor(n,t,i){this.id=n,this.addr=i,this.cache=[],this.type=t.type,this.setValue=$f(t.type)}}class gu{constructor(n,t,i){this.id=n,this.addr=i,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=mu(t.type)}}class vu{constructor(n){this.id=n,this.seq=[],this.map={}}setValue(n,t,i){const a=this.seq;for(let o=0,s=a.length;o!==s;++o){const d=a[o];d.setValue(n,t[d.id],i)}}}const si=/(\w+)(\])?(\[|\.)?/g;function Fa(e,n){e.seq.push(n),e.map[n.id]=n}function Su(e,n,t){const i=e.name,a=i.length;for(si.lastIndex=0;;){const o=si.exec(i),s=si.lastIndex;let d=o[1];const T=o[2]==="]",v=o[3];if(T&&(d=d|0),v===void 0||v==="["&&s+2===a){Fa(t,v===void 0?new _u(d,e,n):new gu(d,e,n));break}else{let R=t.map[d];R===void 0&&(R=new vu(d),Fa(t,R)),t=R}}}class Hn{constructor(n,t){this.seq=[],this.map={};const i=n.getProgramParameter(t,n.ACTIVE_UNIFORMS);for(let s=0;s<i;++s){const d=n.getActiveUniform(t,s),T=n.getUniformLocation(t,d.name);Su(d,T,this)}const a=[],o=[];for(const s of this.seq)s.type===n.SAMPLER_2D_SHADOW||s.type===n.SAMPLER_CUBE_SHADOW||s.type===n.SAMPLER_2D_ARRAY_SHADOW?a.push(s):o.push(s);a.length>0&&(this.seq=a.concat(o))}setValue(n,t,i,a){const o=this.map[t];o!==void 0&&o.setValue(n,i,a)}setOptional(n,t,i){const a=t[i];a!==void 0&&this.setValue(n,i,a)}static upload(n,t,i,a){for(let o=0,s=t.length;o!==s;++o){const d=t[o],T=i[d.id];T.needsUpdate!==!1&&d.setValue(n,T.value,a)}}static seqWithValue(n,t){const i=[];for(let a=0,o=n.length;a!==o;++a){const s=n[a];s.id in t&&i.push(s)}return i}}function Ga(e,n,t){const i=e.createShader(n);return e.shaderSource(i,t),e.compileShader(i),i}const Eu=37297;let xu=0;function Mu(e,n){const t=e.split(`
`),i=[],a=Math.max(n-6,0),o=Math.min(n+6,t.length);for(let s=a;s<o;s++){const d=s+1;i.push(`${d===n?">":" "} ${d}: ${t[s]}`)}return i.join(`
`)}const Oa=new Ne;function Tu(e){Je._getMatrix(Oa,Je.workingColorSpace,e);const n=`mat3( ${Oa.elements.map(t=>t.toFixed(4))} )`;switch(Je.getTransfer(e)){case yr:return[n,"LinearTransferOETF"];case Ze:return[n,"sRGBTransferOETF"];default:return Ve("WebGLProgram: Unsupported color space: ",e),[n,"LinearTransferOETF"]}}function Ba(e,n,t){const i=e.getShaderParameter(n,e.COMPILE_STATUS),o=(e.getShaderInfoLog(n)||"").trim();if(i&&o==="")return"";const s=/ERROR: 0:(\d+)/.exec(o);if(s){const d=parseInt(s[1]);return t.toUpperCase()+`

`+o+`

`+Mu(e.getShaderSource(n),d)}else return o}function Au(e,n){const t=Tu(n);return[`vec4 ${e}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}const bu={[Lr]:"Linear",[wr]:"Reinhard",[Pr]:"Cineon",[Dr]:"ACESFilmic",[Cr]:"AgX",[Rr]:"Neutral",[br]:"Custom"};function Ru(e,n){const t=bu[n];return t===void 0?(Ve("WebGLProgram: Unsupported toneMapping:",n),"vec3 "+e+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+e+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const yn=new Ue;function Cu(){Je.getLuminanceCoefficients(yn);const e=yn.x.toFixed(4),n=yn.y.toFixed(4),t=yn.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${e}, ${n}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function Du(e){return[e.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",e.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(En).join(`
`)}function Pu(e){const n=[];for(const t in e){const i=e[t];i!==!1&&n.push("#define "+t+" "+i)}return n.join(`
`)}function wu(e,n){const t={},i=e.getProgramParameter(n,e.ACTIVE_ATTRIBUTES);for(let a=0;a<i;a++){const o=e.getActiveAttrib(n,a),s=o.name;let d=1;o.type===e.FLOAT_MAT2&&(d=2),o.type===e.FLOAT_MAT3&&(d=3),o.type===e.FLOAT_MAT4&&(d=4),t[s]={type:o.type,location:e.getAttribLocation(n,s),locationSize:d}}return t}function En(e){return e!==""}function Ha(e,n){const t=n.numSpotLightShadows+n.numSpotLightMaps-n.numSpotLightShadowsWithMaps;return e.replace(/NUM_DIR_LIGHTS/g,n.numDirLights).replace(/NUM_SPOT_LIGHTS/g,n.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,n.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,n.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,n.numPointLights).replace(/NUM_HEMI_LIGHTS/g,n.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,n.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,n.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,n.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,n.numPointLightShadows)}function Va(e,n){return e.replace(/NUM_CLIPPING_PLANES/g,n.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,n.numClippingPlanes-n.numClipIntersection)}const Lu=/^[ \t]*#include +<([\w\d./]+)>/gm;function xi(e){return e.replace(Lu,yu)}const Uu=new Map;function yu(e,n){let t=we[n];if(t===void 0){const i=Uu.get(n);if(i!==void 0)t=we[i],Ve('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',n,i);else throw new Error("THREE.WebGLProgram: Can not resolve #include <"+n+">")}return xi(t)}const Iu=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Wa(e){return e.replace(Iu,Nu)}function Nu(e,n,t,i){let a="";for(let o=parseInt(n);o<parseInt(t);o++)a+=i.replace(/\[\s*i\s*\]/g,"[ "+o+" ]").replace(/UNROLLED_LOOP_INDEX/g,o);return a}function za(e){let n=`precision ${e.precision} float;
...
`;class Bd{constructor(){ye(this,"config",{...nr});ye(this,"inverseCoverage",1/nr.coverage);ye(this,"renderer");ye(this,"targets");ye(this,"readTarget",0);ye(this,"recoveryFloorRatio",ir);ye(this,"scene",new Ms);ye(this,"camera",new Ai(-1,1,1,-1,0,1));ye(this,"center",new it);ye(this,"previousCenter",new it);ye(this,"focus",new it);ye(this,"contacts",new Float32Array(xn*fi));ye(this,"contactCount",0);ye(this,"accumulatedDeltaSeconds",0);ye(this,"material");ye(this,"quad");ye(this,"hasFocus",!1);ye(this,"enabled",!1)}configure(n){const t={...this.config,...n};if(Hd(t),this.config=t,this.inverseCoverage=1/this.config.coverage,this.renderer){const i=this.renderer;this.releaseTargets(),this.attach(i)}}attach(n){if(this.targets){if(this.renderer===n)return;this.releaseTargets()}this.renderer=n;const t=[];try{const i=this.targetSize(),a=Wd(n);this.recoveryFloorRatio=a===Vt?ir:Id;const o=rr(i,a);t.push(o);const s=rr(i,a);t.push(s),this.targets=[o,s],t.length=0,this.material=new zt({vertexShader:Gd,fragmentShader:Od,depthTest:!1,depthWrite:!1,uniforms:{uPrevious:{value:this.targets[0].texture},uCenter:{value:new it},uPreviousCenter:{value:new it},uCoverage:{value:this.config.coverage},uInitialize:{value:0},uDelta:{value:0},uRecoveryRate:{value:this.config.recoveryRate},uRecoveryFloor:{value:this.config.recoveryRate*this.recoveryFloorRatio},uFreshnessRate:{value:this.config.freshnessRate},uContactCount:{value:0},uContacts:{value:Array.from({length:xn},()=>new St)},uContactShapes:{value:Array.from({length:xn},()=>new St(0,1,0,0))}}}),this.quad=new Wt(new Ci(2,2),this.material),this.quad.frustumCulled=!1,this.scene.add(this.quad),this.enabled=!0,this.primeTargets()}catch(i){for(const a of t)a.dispose();throw this.releaseTargets(),this.renderer=void 0,i}}setFocus(n,t){!Number.isFinite(n)||!Number.isFinite(t)||(this.focus.set(n,t),this.hasFocus=!0)}submitContact(n,t,i,a,o,s,d,T){if(!Vd(n,t,i,a,o,s,d,T)||a<=0||i<=0||this.contactCount>=xn)return;const v=this.contactCount*fi;this.contacts[v]=n,this.contacts[v+1]=t,this.contacts[v+2]=i,this.contacts[v+3]=a,this.contacts[v+4]=o,this.contacts[v+5]=s,this.contacts[v+6]=d,this.contacts[v+7]=T,this.contactCount+=1}render(n){const t=this.renderer,i=this.targets,a=this.material;if(!t||!i||!a||!this.enabled||!this.hasFocus){this.resetPendingFrame();return}if(!Number.isFinite(n)||n<=0){this.resetPendingFrame();return}if(this.accumulatedDeltaSeconds=Math.min(ar,this.accumulatedDeltaSeconds+Math.min(n,ar)),this.accumulatedDeltaSeconds+Fd<Nd){this.contactCount=0;return}const o=this.accumulatedDeltaSeconds;this.accumulatedDeltaSeconds=0,this.previousCenter.copy(this.center);const s=this.config.coverage/this.targetSize();this.center.set(Math.round(this.focus.x/s)*s,Math.round(this.focus.y/s)*s);const d=a.uniforms;d.uPrevious.value=i[this.readTarget].texture,d.uCenter.value.copy(this.center),d.uPreviousCenter.value.copy(this.previousCenter),d.uCoverage.value=this.config.coverage,d.uDelta.value=o,d.uRecoveryRate.value=this.config.recoveryRate,d.uRecoveryFloor.value=this.config.recoveryRate*this.recoveryFloorRatio,d.uFreshnessRate.value=this.config.freshnessRate,d.uContactCount.value=this.contactCount;const T=d.uContacts.value,v=d.uContactShapes.value;for(let h=0;h<this.contactCount;h+=1){const S=h*fi;T[h].set(this.contacts[S],this.contacts[S+1],this.contacts[S+2],this.contacts[S+3]),v[h].set(this.contacts[S+4],this.contacts[S+5],Pt.clamp(this.contacts[S+6],0,.95),Pt.clamp(this.contacts[S+7],0,1))}this.contactCount=0;const G=1-this.readTarget,R=t.getRenderTarget();try{t.setRenderTarget(i[G]),t.render(this.scene,this.camera),this.readTarget=G}finally{t.setRenderTarget(R)}}isEnabled(){return this.enabled&&this.hasFocus&&this.targets!==void 0}getTexture(){var n;return((n=this.targets)==null?void 0:n[this.readTarget].texture)??null}getCenter(){return this.center}getInverseCoverage(){return this.inverseCoverage}dispose(){this.releaseTargets(),this.renderer=void 0,this.enabled=!1,this.hasFocus=!1,this.resetPendingFrame()}targetSize(){return Math.max(32,Math.round(this.config.resolution))}resetPendingFrame(){this.contactCount=0,this.accumulatedDeltaSeconds=0}releaseTargets(){var n;this.quad&&(this.scene.remove(this.quad),this.quad.geometry.dispose(),this.quad=void 0),(n=this.material)==null||n.dispose(),this.material=void 0;for(const t of this.targets??[])t.dispose();this.targets=void 0,this.readTarget=0,this.enabled=!1}primeTargets(){const n=this.renderer,t=this.targets,i=this.material;if(!n||!t||!i)return;i.uniforms.uInitialize.value=1,i.uniforms.uContactCount.value=0,i.uniforms.uDelta.value=0;const a=n.getRenderTarget();try{for(const o of t)n.setRenderTarget(o),n.render(this.scene,this.camera)}finally{n.setRenderTarget(a),i.uniforms.uInitialize.value=0}}}function Hd(e){if(!Number.isInteger(e.resolution)||e.resolution<32)throw new Error("Grass trail resolution must be an integer of at least 32.");for(const[n,t]of[["coverage",e.coverage],["recoveryRate",e.recoveryRate],["freshnessRate",e.freshnessRate]])if(!Number.isFinite(t)||t<=0)throw new Error(`Grass trail ${n} must be a positive finite number.`)}function Vd(...e){return e.every(Number.isFinite)}function Wd(e){const n=e.extensions;return n.has("EXT_color_buffer_half_float")||n.has("EXT_color_buffer_float")?Vt:Ct}function rr(e,n){const t=new wt(e,e,{format:Bt,type:n,minFilter:_t,magFilter:_t,wrapS:bn,wrapT:bn,depthBuffer:!1,stencilBuffer:!1,generateMipmaps:!1});return t.texture.colorSpace=$t,t}const In=new Bd,zd=1/48,kd=.06,Xd=.085,qd=.55,Yd=.037,Kd=.31,$d=1.7,Zd=.72,jd=.28;function Qd(e){const{target:n,position:t,windDirection:i,time:a,scale:o,speed:s}=e;return`
float ${n} = 0.5 + 0.5 * (
  sin(
    dot(${t}, ${i}) * ${o} -
    ${a} * ${s}
...
`}const Dt=128,ui=4,di=11;function Nn(e,n,t){let i=Math.imul(e,374761393)^Math.imul(n,668265263)^t;return i=Math.imul(i^i>>>13,1274126177),((i^i>>>16)>>>0)/4294967296}function or(e,n,t,i){const a=Math.floor(e),o=Math.floor(n),s=e-a,d=n-o,T=s*s*(3-2*s),v=d*d*(3-2*d),G=(a%t+t)%t,R=(o%t+t)%t,h=(G+1)%t,S=(R+1)%t,C=Nn(G,R,i),B=Nn(h,R,i),u=Nn(G,S,i),c=Nn(h,S,i),y=C+(B-C)*T,I=u+(c-u)*T;return y+(I-y)*v}function sr(e){return Math.max(0,Math.min(255,Math.round(e*255)))}function Jd(e=1597334677){const n=new Uint8Array(Dt*Dt*2);for(let i=0;i<Dt;i+=1)for(let a=0;a<Dt;a+=1){const o=a/Dt*ui,s=i/Dt*ui,d=or(o,s,ui,e),T=or(a/Dt*di,i/Dt*di,di,e^2654435769),v=(d+T*.5)/1.5,G=v*v*(3-2*v),R=(i*Dt+a)*2;n[R]=sr(G),n[R+1]=sr(T)}const t=new hr(n,Dt,Dt,on,Ct);return t.name="grass-wind-noise",t.wrapS=_i,t.wrapT=_i,t.minFilter=_t,t.magFilter=_t,t.generateMipmaps=!1,t.colorSpace=$t,t.needsUpdate=!0,t}let nn;function Th(){return nn||(nn=Jd()),nn}function Ah(){nn==null||nn.dispose(),nn=void 0}const ep=.28,tp=1,np=1.7,ip=1.02,ap=.18,rp=.2,op=.035,sp=.18,lp=.02,cp=.12,fp=.55,up=.82,dp=1.15,Tt={tipStart:ep,tipEnd:tp,tipLuminanceScale:np,dryLuminanceScale:ip,shadeDrynessPivot:ap,shadeDrynessScale:rp,shadeDrynessMaximum:op,instanceDrynessBase:sp,instanceDrynessTip:lp,drynessMaximum:cp,rootFadeEnd:fp,shadeLightMinimum:up,shadeLightMaximum:dp},pi=new Ue(.2126,.7152,.0722);function Rt(e){if(!Number.isFinite(e))throw new TypeError("Grass palette GLSL values must be finite.");return Number.isInteger(e)?`${e}.0`:String(e)}function hi(e){return e.r*pi.x+e.g*pi.y+e.b*pi.z}function lr(e,n,t,i,a,o){e.set(i),n.set(a),t.set(o);const s=Math.max(hi(e),1e-4);n.multiplyScalar(s*Tt.tipLuminanceScale/Math.max(hi(n),1e-4)),t.multiplyScalar(s*Tt.dryLuminanceScale/Math.max(hi(t),1e-4))}const pp=.62,hp=Rt(pp),Wr=`
vec3 grassResolvePalette(
  ...
  float shadeDryness = clamp(
    (${Rt(Tt.shadeDrynessPivot)} - shade) *
      ${Rt(Tt.shadeDrynessScale)},
    0.0,
    ${Rt(Tt.shadeDrynessMaximum)}
  );
  float instanceDryness = dryness * (
    ${Rt(Tt.instanceDrynessBase)} +
    tipProfile * ${Rt(Tt.instanceDrynessTip)}
  );
  vec3 paletteColor = mix(
    ...
    clamp(
      ...
      0.0,
      ${Rt(Tt.drynessMaximum)}
    )
  );
  float rootLight = mix(
    rootDarkening,
    1.0,
    smoothstep(0.0, ${Rt(Tt.rootFadeEnd)}, progress)
  );
  float bladeVariation = mix(
    ${Rt(Tt.shadeLightMinimum)},
    ${Rt(Tt.shadeLightMaximum)},
    shade
  );
  return paletteColor * rootLight * bladeVariation * rootAo;
}
`,mp={index:0,label:"Meadow",paletteSource:"art",worldShare:.62,baseColor:"#3f8330",tipColor:"#a9db57",dryColor:"#b3ac5e",rootDarkening:.36,tipColorStrength:.46,density:1,heightBand:[.86,1.14],widthBand:[.86,1.1],drynessBias:0,windDamping:1,shapeFamily:"blade",accentDensity:1,accentSpecies:[{species:"daisy",tint:"white",weight:1.2},{species:"daisy",tint:"cream",weight:.7},{species:"daisy",tint:"sky-blue",weight:.25},{species:"round-bloom",tint:"pink",weight:.35},{species:"round-bloom",tint:"lavender",weight:.25},{species:"round-bloom",tint:"buttercup",weight:.15},{species:"round-bloom",tint:"poppy-red",weight:.1},{species:"fern",tint:"none",weight:2},{species:"small-fern",tint:"none",weight:1},{species:"grass-tuft",tint:"none",weight:4},{species:"sprig",tint:"none",weight:2}]},_p={index:2,label:"Alpine",paletteSource:"profile",worldShare:.18,baseColor:"#2f6b45",tipColor:"#7fae7a",dryColor:"#8d9573",rootDarkening:.42,tipColorStrength:.42,density:.7,heightBand:[.7,.9],widthBand:[.85,1],drynessBias:.12,windDamping:.8,shapeFamily:"blade",accentDensity:.5,accentSpecies:[{species:"grass-tuft",tint:"none",weight:4},{species:"daisy",tint:"white",weight:.75},{species:"daisy",tint:"cream",weight:.35},{species:"daisy",tint:"sky-blue",weight:.35},{species:"round-bloom",tint:"lavender",weight:.75},{species:"round-bloom",tint:"pink",weight:.35},{species:"small-fern",tint:"none",weight:1}]},gp={meadow:mp,"dry-steppe":{index:1,label:"Dry Steppe",paletteSource:"profile",worldShare:.2,baseColor:"#7a7a3c",tipColor:"#cbbf6a",dryColor:"#c2a35a",rootDarkening:.44,tipColorStrength:.44,density:.55,heightBand:[.78,1.02],widthBand:[.8,.98],drynessBias:.35,windDamping:.9,shapeFamily:"blade",accentDensity:.6,accentSpecies:[{species:"seed-head",tint:"straw",weight:4},{species:"tall-tuft",tint:"none",weight:3},{species:"grass-tuft",tint:"none",weight:2},{species:"round-bloom",tint:"buttercup",weight:.55},{species:"round-bloom",tint:"cream",weight:.25},{species:"round-bloom",tint:"poppy-red",weight:.1}]},alpine:_p},bh=8,Rh=8;function Ch(e,n){return(e+n)*.5}const vp=Object.freeze([{key:"grass-tuft",category:"tuft",aspect:.9,windWeight:.85,canopyHeightBand:[.7,.95]},{key:"tall-tuft",category:"tuft",aspect:.6,windWeight:1,canopyHeightBand:[1,1.3]},{key:"fern",category:"fern",aspect:1,windWeight:.35,canopyHeightBand:[.85,1.15]},{key:"small-fern",category:"fern",aspect:.95,windWeight:.4,canopyHeightBand:[.58,.82]},{key:"daisy",category:"flower",aspect:.72,windWeight:.7,canopyHeightBand:[.88,1.58]},{key:"round-bloom",category:"flower",aspect:.9,windWeight:.65,canopyHeightBand:[.82,1.46]},{key:"seed-head",category:"seed",aspect:.5,windWeight:1,canopyHeightBand:[1.3,1.72]},{key:"sprig",category:"tuft",aspect:.7,windWeight:.55,canopyHeightBand:[.7,1]}].map((e,n)=>Object.freeze({...e,index:n}))),zr=Object.freeze([{key:"white",color:"#ddd8c6"},{key:"cream",color:"#d4c7a3"},{key:"buttercup",color:"#c9ac62"},{key:"poppy-red",color:"#a56a5d"},{key:"pink",color:"#bf939e"},{key:"lavender",color:"#9f96ae"},{key:"straw",color:"#b9ad86"},{key:"sky-blue",color:"#8fa5ad"}]),Cn="none";function Sp(e){return vp.find(n=>n.key===e)}function Dh(e){if(e===Cn)return 0;const n=zr.findIndex(t=>t.key===e);return n<0?0:n}function Ph(e,n,t){return e*16+n*8+t}const hn=8,Ep=Object.freeze([{species:"daisy",tint:"white",weight:3},{species:"round-bloom",tint:"poppy-red",weight:1},{species:"fern",tint:Cn,weight:2},{species:"grass-tuft",tint:Cn,weight:4}]),xp=Object.freeze([.7,1.14]),Mp=Object.freeze([.76,1.1]),cr=Object.freeze([.7,1]),wh=1,Tp=/^#[0-9a-f]{6}$/i;function pt(e){throw new Error(`[grass-biome] ${e}`)}function Mi(e,n){return(typeof e!="object"||e===null||Array.isArray(e))&&pt(`${n} must be an object.`),e}function Ft(e,n,t,i){return(typeof e!="number"||!Number.isFinite(e))&&pt(`${i} must be a finite number.`),(e<n||e>t)&&pt(`${i} must be within [${n}, ${t}], got ${e}.`),e}function fr(e,n,t){(!Array.isArray(e)||e.length!==2)&&pt(`${t} must be a two-element band.`);const i=Ft(e[0],n[0],n[1],`${t} minimum`),a=Ft(e[1],n[0],n[1],`${t} maximum`);return i>a&&pt(`${t} is reversed.`),[i,a]}function Ap(e,n){return e===void 0?Ep:((!Array.isArray(e)||e.length===0)&&pt(`${n} must be a non-empty array when present.`),Object.freeze(e.map((t,i)=>{const a=`${n}[${i}]`,o=Mi(t,a);(typeof o.species!="string"||!Sp(o.species))&&pt(`${a} names an unknown accent species.`);const s=o.tint??Cn;return(typeof s!="string"||s!==Cn&&!zr.some(d=>d.key===s))&&pt(`${a} names an unknown accent tint.`),Object.freeze({species:o.species,tint:s,weight:Ft(o.weight,.01,16,`${a} weight`)})})))}function bp(e,n){const t=n.index;(typeof t!="number"||!Number.isInteger(t)||t<0)&&pt(`Biome ${e} needs a non-negative integer index.`),(typeof n.label!="string"||n.label.length===0)&&pt(`Biome ${e} needs a label.`),n.paletteSource!=="art"&&n.paletteSource!=="profile"&&pt(`Biome ${e} paletteSource must be "art" or "profile".`),t===0&&n.paletteSource!=="art"&&pt("Biome 0 must take the art direction's palette so a single-biome world renders identically to one without biome support.");for(const i of["baseColor","tipColor","dryColor"])(typeof n[i]!="string"||!Tp.test(n[i]))&&pt(`Biome ${e} ${i} must be #RRGGBB.`);return(typeof n.shapeFamily!="string"||n.shapeFamily.length===0)&&pt(`Biome ${e} needs a shapeFamily.`),{key:e,index:t,label:n.label,paletteSource:n.paletteSource,baseColor:n.baseColor,tipColor:n.tipColor,dryColor:n.dryColor,rootDarkening:Ft(n.rootDarkening,0,1,`Biome ${e} rootDarkening`),tipColorStrength:Ft(n.tipColorStrength,0,1,`Biome ${e} tipColorStrength`),worldShare:Ft(n.worldShare,.01,1,`Biome ${e} worldShare`),density:Ft(n.density,1e-4,1,`Biome ${e} density`),heightBand:fr(n.heightBand,xp,`Biome ${e} heightBand`),widthBand:fr(n.widthBand,Mp,`Biome ${e} widthBand`),drynessBias:Ft(n.drynessBias,0,.6,`Biome ${e} drynessBias`),windDamping:Ft(n.windDamping,cr[0],cr[1],`Biome ${e} windDamping`),shapeFamily:n.shapeFamily,accentDensity:n.accentDensity===void 0?1:Ft(n.accentDensity,0,1,`Biome ${e} accentDensity`),accentSpecies:Ap(n.accentSpecies,`Biome ${e} accentSpecies`)}}function Rp(){const e=Mi(gp,"Grass biome profile data"),n=Object.entries(e);n.length===0&&pt("At least one biome profile is required."),n.length>hn&&pt(`At most ${hn} biome profiles fit the bounded palette uniform arrays, found ${n.length}.`);const t=n.map(([a,o])=>bp(a,Mi(o,`Biome ${a}`)));t.sort((a,o)=>a.index-o.index),t.forEach((a,o)=>{a.index!==o&&pt(`Biome indices must be dense from 0; ${a.key} has index ${a.index} at position ${o}.`)});const i=t.reduce((a,o)=>a+o.worldShare,0);return t.length>1&&t[0].worldShare/i<.4&&pt("Biome 0 must hold at least 40% of the world: it carries the art direction's palette, and a world where it is a minority no longer looks like the active preset."),Object.freeze(t.map(a=>Object.freeze(a)))}const Pi=Rp();function Wn(e){return(e[0]+e[1])*.5}function Lh(e){return Math.min(1,Wn(e.heightBand)/Wn(Pi[0].heightBand))}function Uh(e){return Math.min(1,Wn(e.widthBand)/Wn(Pi[0].widthBand))}const Cp=1.29,Dp=12,Pp=.16,wp=.55,ur=.09,Lp=42,Up=18,dr=.55,yp=.00107,Ip=1.15,Np=3,pr=.06,kr=30,Xr=64,yh=Object.freeze({start:kr,end:Xr,floor:.35}),qr=`
#define GRASS_MAX_BIOMES ${hn}
...
`,Kp=Qd({target:"grassGustNoise",position:"grassWorldRoot.xz",windDirection:"uGrassWindDirection",time:"uGrassTime",scale:"uGrassGustFrontScale",speed:"uGrassGustFrontSpeed"}),$p=`
...
vec3 outgoingLight =
  mix(diffuseColor.rgb, grassLambertLight, ${hp}) +
