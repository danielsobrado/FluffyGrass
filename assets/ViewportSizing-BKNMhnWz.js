...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:zt,depthTest:!1,depthWrite:!1})}function Af(e,n,t){const i=new Float32Array(en),a=new Ie(0,1,0);return new kt({name:"SphericalGaussianBlur",defines:{n:en,CUBEUV_TEXEL_WIDTH:1/n,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:i},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:a}},vertexShader:Xn(),fragmentShader:`
		...
		`,blending:zt,depthTest:!1,depthWrite:!1})}function wa(){return new kt({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Xn(),fragmentShader:`
		...
		`,blending:zt,depthTest:!1,depthWrite:!1})}function Ua(){return new kt({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Xn(),fragmentShader:`
		...
		`,blending:zt,depthTest:!1,depthWrite:!1})}function Xn(){return`
...
`)}const Pu={[Nr]:"Linear",[yr]:"Reinhard",[Ir]:"Cineon",[Ur]:"ACESFilmic",[wr]:"AgX",[Lr]:"Neutral",[Pr]:"Custom"};function Lu(e,n){const t=Pu[n];return t===void 0?(Ve("WebGLProgram: Unsupported toneMapping:",n),"vec3 "+e+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+e+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const In=new Ie;function wu(){Je.getLuminanceCoefficients(In);const e=In.x.toFixed(4),n=In.y.toFixed(4),t=In.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${e}, ${n}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function Uu(e){return[e.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",e.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(En).join(`
`)}function Iu(e){const n=[];for(const t in e){const i=e[t];i!==!1&&n.push("#define "+t+" "+i)}return n.join(`
`)}function yu(e,n){const t={},i=e.getProgramParameter(n,e.ACTIVE_ATTRIBUTES);for(let a=0;a<i;a++){const o=e.getActiveAttrib(n,a),s=o.name;let d=1;o.type===e.FLOAT_MAT2&&(d=2),o.type===e.FLOAT_MAT3&&(d=3),o.type===e.FLOAT_MAT4&&(d=4),t[s]={type:o.type,location:e.getAttribLocation(n,s),locationSize:d}}return t}function En(e){return e!==""}function Wa(e,n){const t=n.numSpotLightShadows+n.numSpotLightMaps-n.numSpotLightShadowsWithMaps;return e.replace(/NUM_DIR_LIGHTS/g,n.numDirLights).replace(/NUM_SPOT_LIGHTS/g,n.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,n.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,n.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,n.numPointLights).replace(/NUM_HEMI_LIGHTS/g,n.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,n.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,n.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,n.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,n.numPointLightShadows)}function ka(e,n){return e.replace(/NUM_CLIPPING_PLANES/g,n.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,n.numClippingPlanes-n.numClipIntersection)}const Nu=/^[ \t]*#include +<([\w\d./]+)>/gm;function Ti(e){return e.replace(Nu,Gu)}const Fu=new Map;function Gu(e,n){let t=Le[n];if(t===void 0){const i=Fu.get(n);if(i!==void 0)t=Le[i],Ve('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',n,i);else throw new Error("THREE.WebGLProgram: Can not resolve #include <"+n+">")}return Ti(t)}const Ou=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function za(e){return e.replace(Ou,Bu)}function Bu(e,n,t,i){let a="";for(let o=parseInt(n);o<parseInt(t);o++)a+=i.replace(/\[\s*i\s*\]/g,"[ "+o+" ]").replace(/UNROLLED_LOOP_INDEX/g,o);return a}function Xa(e){let n=`precision ${e.precision} float;
...
#define LOW_PRECISION`),n}const Hu={[On]:"SHADOWMAP_TYPE_PCF",[Sn]:"SHADOWMAP_TYPE_VSM"};function Vu(e){return Hu[e.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const Wu={[Rn]:"ENVMAP_TYPE_CUBE",[pn]:"ENVMAP_TYPE_CUBE",[zn]:"ENVMAP_TYPE_CUBE_UV"};function ku(e){return e.envMap===!1?"ENVMAP_TYPE_CUBE":Wu[e.envMapMode]||"ENVMAP_TYPE_CUBE"}const zu={[pn]:"ENVMAP_MODE_REFRACTION"};function Xu(e){return e.envMap===!1?"ENVMAP_MODE_REFLECTION":zu[e.envMapMode]||"ENVMAP_MODE_REFLECTION"}const qu={[Es]:"ENVMAP_BLENDING_MULTIPLY",[Ss]:"ENVMAP_BLENDING_MIX",[vs]:"ENVMAP_BLENDING_ADD"};function Yu(e){return e.envMap===!1?"ENVMAP_BLENDING_NONE":qu[e.combine]||"ENVMAP_BLENDING_NONE"}function Ku(e){const n=e.envMapCubeUVHeight;if(n===null)return null;const t=Math.log2(n)-2,i=1/n;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:i,maxMip:t}}function $u(e,n,t,i){const a=e.getContext(),o=t.defines;let s=t.vertexShader,d=t.fragmentShader;const T=Vu(t),v=ku(t),G=Xu(t),R=Yu(t),h=Ku(t),S=Uu(t),C=Iu(o),B=a.createProgram();let u,c,I=t.glslVersion?"#version "+t.glslVersion+`
...
`}const Dt=128,pi=4,hi=11;function Nn(e,n,t){let i=Math.imul(e,374761393)^Math.imul(n,668265263)^t;return i=Math.imul(i^i>>>13,1274126177),((i^i>>>16)>>>0)/4294967296}function fr(e,n,t,i){const a=Math.floor(e),o=Math.floor(n),s=e-a,d=n-o,T=s*s*(3-2*s),v=d*d*(3-2*d),G=(a%t+t)%t,R=(o%t+t)%t,h=(G+1)%t,S=(R+1)%t,C=Nn(G,R,i),B=Nn(h,R,i),u=Nn(G,S,i),c=Nn(h,S,i),I=C+(B-C)*T,y=u+(c-u)*T;return I+(y-I)*v}function ur(e){return Math.max(0,Math.min(255,Math.round(e*255)))}function lp(e=1597334677){const n=new Uint8Array(Dt*Dt*2);for(let i=0;i<Dt;i+=1)for(let a=0;a<Dt;a+=1){const o=a/Dt*pi,s=i/Dt*pi,d=fr(o,s,pi,e),T=fr(a/Dt*hi,i/Dt*hi,hi,e^2654435769),v=(d+T*.5)/1.5,G=v*v*(3-2*v),R=(i*Dt+a)*2;n[R]=ur(G),n[R+1]=ur(T)}const t=new vr(n,Dt,Dt,on,Ct);return t.name="grass-wind-noise",t.wrapS=vi,t.wrapT=vi,t.minFilter=gt,t.magFilter=gt,t.generateMipmaps=!1,t.colorSpace=$t,t.needsUpdate=!0,t}let nn;function $h(){return nn||(nn=lp()),nn}function Zh(){nn==null||nn.dispose(),nn=void 0}const cp=.28,fp=1,up=1.7,dp=1.02,pp=.18,hp=.2,mp=.035,_p=.18,gp=.02,vp=.12,Sp=.55,Ep=.82,xp=1.15,Tt={tipStart:cp,tipEnd:fp,tipLuminanceScale:up,dryLuminanceScale:dp,shadeDrynessPivot:pp,shadeDrynessScale:hp,shadeDrynessMaximum:mp,instanceDrynessBase:_p,instanceDrynessTip:gp,drynessMaximum:vp,rootFadeEnd:Sp,shadeLightMinimum:Ep,shadeLightMaximum:xp},mi=new Ie(.2126,.7152,.0722);function Rt(e){if(!Number.isFinite(e))throw new TypeError("Grass palette GLSL values must be finite.");return Number.isInteger(e)?`${e}.0`:String(e)}function _i(e){return e.r*mi.x+e.g*mi.y+e.b*mi.z}function dr(e,n,t,i,a,o){e.set(i),n.set(a),t.set(o);const s=Math.max(_i(e),1e-4);n.multiplyScalar(s*Tt.tipLuminanceScale/Math.max(_i(n),1e-4)),t.multiplyScalar(s*Tt.dryLuminanceScale/Math.max(_i(t),1e-4))}const Mp=.62,Tp=Rt(Mp),qr=`
...
`,Ap={index:0,label:"Meadow",paletteSource:"art",worldShare:.62,baseColor:"#3f8330",tipColor:"#a9db57",dryColor:"#b3ac5e",rootDarkening:.36,tipColorStrength:.46,density:1,heightBand:[.86,1.14],widthBand:[.86,1.1],drynessBias:0,windDamping:1,shapeFamily:"blade",accentDensity:1,accentSpecies:[{species:"daisy",tint:"white",weight:1.2},{species:"daisy",tint:"cream",weight:.7},{species:"daisy",tint:"sky-blue",weight:.25},{species:"round-bloom",tint:"pink",weight:.35},{species:"round-bloom",tint:"lavender",weight:.25},{species:"round-bloom",tint:"buttercup",weight:.15},{species:"round-bloom",tint:"poppy-red",weight:.1},{species:"fern",tint:"none",weight:2},{species:"small-fern",tint:"none",weight:1},{species:"grass-tuft",tint:"none",weight:4},{species:"sprig",tint:"none",weight:2}]},bp={index:2,label:"Alpine",paletteSource:"profile",worldShare:.18,baseColor:"#2f6b45",tipColor:"#7fae7a",dryColor:"#8d9573",rootDarkening:.42,tipColorStrength:.42,density:.7,heightBand:[.7,.9],widthBand:[.85,1],drynessBias:.12,windDamping:.8,shapeFamily:"blade",accentDensity:.5,accentSpecies:[{species:"grass-tuft",tint:"none",weight:4},{species:"daisy",tint:"white",weight:.75},{species:"daisy",tint:"cream",weight:.35},{species:"daisy",tint:"sky-blue",weight:.35},{species:"round-bloom",tint:"lavender",weight:.75},{species:"round-bloom",tint:"pink",weight:.35},{species:"small-fern",tint:"none",weight:1}]},Rp={meadow:Ap,"dry-steppe":{index:1,label:"Dry Steppe",paletteSource:"profile",worldShare:.2,baseColor:"#7a7a3c",tipColor:"#cbbf6a",dryColor:"#c2a35a",rootDarkening:.44,tipColorStrength:.44,density:.55,heightBand:[.78,1.02],widthBand:[.8,.98],drynessBias:.35,windDamping:.9,shapeFamily:"blade",accentDensity:.6,accentSpecies:[{species:"seed-head",tint:"straw",weight:4},{species:"tall-tuft",tint:"none",weight:3},{species:"grass-tuft",tint:"none",weight:2},{species:"round-bloom",tint:"buttercup",weight:.55},{species:"round-bloom",tint:"cream",weight:.25},{species:"round-bloom",tint:"poppy-red",weight:.1}]},alpine:bp},jh=8,Qh=8;function Jh(e,n){return(e+n)*.5}const Cp=Object.freeze([{key:"grass-tuft",category:"tuft",aspect:.9,windWeight:.85,canopyHeightBand:[.7,.95]},{key:"tall-tuft",category:"tuft",aspect:.6,windWeight:1,canopyHeightBand:[1,1.3]},{key:"fern",category:"fern",aspect:1,windWeight:.35,canopyHeightBand:[.85,1.15]},{key:"small-fern",category:"fern",aspect:.95,windWeight:.4,canopyHeightBand:[.58,.82]},{key:"daisy",category:"flower",aspect:.72,windWeight:.7,canopyHeightBand:[.88,1.58]},{key:"round-bloom",category:"flower",aspect:.9,windWeight:.65,canopyHeightBand:[.82,1.46]},{key:"seed-head",category:"seed",aspect:.5,windWeight:1,canopyHeightBand:[1.3,1.72]},{key:"sprig",category:"tuft",aspect:.7,windWeight:.55,canopyHeightBand:[.7,1]}].map((e,n)=>Object.freeze({...e,index:n}))),Yr=Object.freeze([{key:"white",color:"#ddd8c6"},{key:"cream",color:"#d4c7a3"},{key:"buttercup",color:"#c9ac62"},{key:"poppy-red",color:"#a56a5d"},{key:"pink",color:"#bf939e"},{key:"lavender",color:"#9f96ae"},{key:"straw",color:"#b9ad86"},{key:"sky-blue",color:"#8fa5ad"}]),Cn="none";function Dp(e){return Cp.find(n=>n.key===e)}function em(e){if(e===Cn)return 0;const n=Yr.findIndex(t=>t.key===e);return n<0?0:n}function tm(e,n,t){return e*16+n*8+t}const hn=8,Pp=Object.freeze([{species:"daisy",tint:"white",weight:3},{species:"round-bloom",tint:"poppy-red",weight:1},{species:"fern",tint:Cn,weight:2},{species:"grass-tuft",tint:Cn,weight:4}]),Lp=Object.freeze([.7,1.14]),wp=Object.freeze([.76,1.1]),pr=Object.freeze([.7,1]),nm=1,Up=/^#[0-9a-f]{6}$/i;function pt(e){throw new Error(`[grass-biome] ${e}`)}function Ai(e,n){return(typeof e!="object"||e===null||Array.isArray(e))&&pt(`${n} must be an object.`),e}function Ft(e,n,t,i){return(typeof e!="number"||!Number.isFinite(e))&&pt(`${i} must be a finite number.`),(e<n||e>t)&&pt(`${i} must be within [${n}, ${t}], got ${e}.`),e}function hr(e,n,t){(!Array.isArray(e)||e.length!==2)&&pt(`${t} must be a two-element band.`);const i=Ft(e[0],n[0],n[1],`${t} minimum`),a=Ft(e[1],n[0],n[1],`${t} maximum`);return i>a&&pt(`${t} is reversed.`),[i,a]}function Ip(e,n){return e===void 0?Pp:((!Array.isArray(e)||e.length===0)&&pt(`${n} must be a non-empty array when present.`),Object.freeze(e.map((t,i)=>{const a=`${n}[${i}]`,o=Ai(t,a);(typeof o.species!="string"||!Dp(o.species))&&pt(`${a} names an unknown accent species.`);const s=o.tint??Cn;return(typeof s!="string"||s!==Cn&&!Yr.some(d=>d.key===s))&&pt(`${a} names an unknown accent tint.`),Object.freeze({species:o.species,tint:s,weight:Ft(o.weight,.01,16,`${a} weight`)})})))}function yp(e,n){const t=n.index;(typeof t!="number"||!Number.isInteger(t)||t<0)&&pt(`Biome ${e} needs a non-negative integer index.`),(typeof n.label!="string"||n.label.length===0)&&pt(`Biome ${e} needs a label.`),n.paletteSource!=="art"&&n.paletteSource!=="profile"&&pt(`Biome ${e} paletteSource must be "art" or "profile".`),t===0&&n.paletteSource!=="art"&&pt("Biome 0 must take the art direction's palette so a single-biome world renders identically to one without biome support.");for(const i of["baseColor","tipColor","dryColor"])(typeof n[i]!="string"||!Up.test(n[i]))&&pt(`Biome ${e} ${i} must be #RRGGBB.`);return(typeof n.shapeFamily!="string"||n.shapeFamily.length===0)&&pt(`Biome ${e} needs a shapeFamily.`),{key:e,index:t,label:n.label,paletteSource:n.paletteSource,baseColor:n.baseColor,tipColor:n.tipColor,dryColor:n.dryColor,rootDarkening:Ft(n.rootDarkening,0,1,`Biome ${e} rootDarkening`),tipColorStrength:Ft(n.tipColorStrength,0,1,`Biome ${e} tipColorStrength`),worldShare:Ft(n.worldShare,.01,1,`Biome ${e} worldShare`),density:Ft(n.density,1e-4,1,`Biome ${e} density`),heightBand:hr(n.heightBand,Lp,`Biome ${e} heightBand`),widthBand:hr(n.widthBand,wp,`Biome ${e} widthBand`),drynessBias:Ft(n.drynessBias,0,.6,`Biome ${e} drynessBias`),windDamping:Ft(n.windDamping,pr[0],pr[1],`Biome ${e} windDamping`),shapeFamily:n.shapeFamily,accentDensity:n.accentDensity===void 0?1:Ft(n.accentDensity,0,1,`Biome ${e} accentDensity`),accentSpecies:Ip(n.accentSpecies,`Biome ${e} accentSpecies`)}}function Np(){const e=Ai(Rp,"Grass biome profile data"),n=Object.entries(e);n.length===0&&pt("At least one biome profile is required."),n.length>hn&&pt(`At most ${hn} biome profiles fit the bounded palette uniform arrays, found ${n.length}.`);const t=n.map(([a,o])=>yp(a,Ai(o,`Biome ${a}`)));t.sort((a,o)=>a.index-o.index),t.forEach((a,o)=>{a.index!==o&&pt(`Biome indices must be dense from 0; ${a.key} has index ${a.index} at position ${o}.`)});const i=t.reduce((a,o)=>a+o.worldShare,0);return t.length>1&&t[0].worldShare/i<.4&&pt("Biome 0 must hold at least 40% of the world: it carries the art direction's palette, and a world where it is a minority no longer looks like the active preset."),Object.freeze(t.map(a=>Object.freeze(a)))}const wi=Np();function kn(e){return(e[0]+e[1])*.5}function im(e){return Math.min(1,kn(e.heightBand)/kn(wi[0].heightBand))}function am(e){return Math.min(1,kn(e.widthBand)/kn(wi[0].widthBand))}const Fp=1.29,Gp=12,Op=.16,Bp=.55,mr=.09,Hp=42,Vp=18,_r=.55,Wp=.00107,kp=1.15,zp=3,gr=.06,Kr=30,$r=64,rm=Object.freeze({start:Kr,end:$r,floor:.35}),Zr=`
...
`,ih=sp({target:"grassGustNoise",position:"grassWorldRoot.xz",windDirection:"uGrassWindDirection",time:"uGrassTime",scale:"uGrassGustFrontScale",speed:"uGrassGustFrontSpeed"}),ah=`
...
vec3 outgoingLight =
  mix(diffuseColor.rgb, grassLambertLight, ${Tp}) +
