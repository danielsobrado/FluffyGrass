...
export const WORLD_CONFIG_SCHEMA: WorldConfigSchema = {
  ...
  horizonApronRings: {
    minimum: 0,
    maximum: MAX_HORIZON_APRON_RINGS,
    integer: true,
  },
  ...
  grassClumpRadiusScaleMin: { minimum: 0.2, maximum: 0.7 },
  grassClumpRadiusScaleMax: { minimum: 0.2, maximum: 0.7 },
  ...
  grassClumpPlaneCoherence: { minimum: 0, maximum: 0.5 },
  grassClumpEdgeCoverage: { minimum: 0.4, maximum: 1 },
  grassAccentBladeShare: { minimum: 0, maximum: 0.2 },
  grassUnderstoryHeightScale: { minimum: 0.25, maximum: 0.75 },
  grassMainHeightScale: { minimum: 0.6, maximum: 1.1 },
  grassAccentHeightScale: { minimum: 1, maximum: 1.22 },
  grassBladeHeightJitter: { minimum: 0, maximum: 0.1 },
  ...
  grassCommunityWorldSize: { minimum: 14, maximum: 48 },
  grassCommunityWarpWorldSize: { minimum: 48, maximum: 180 },
  grassCommunityWarpDistance: { minimum: 0, maximum: 24 },
  grassCommunityEcologyStrength: { minimum: 0, maximum: 1 },
  grassCommunityStrength: { minimum: 0, maximum: 1 },
  grassCommunityBorderWidth: { minimum: 0.05, maximum: 0.5 },
  grassCommunityQuietStrength: { minimum: 0, maximum: 1 },
  terrainCommunityTintStrength: { minimum: 0, maximum: 1 },
  detailFoliageCommunityStrength: { minimum: 0, maximum: 1 },
  detailFoliageGrassHeightCoupling: { minimum: 0, maximum: 1 },
  ...
  pathGrassEdgeRoughness: { minimum: 0, maximum: 2.5 },
  grassPathPioneerChance: { minimum: 0, maximum: 0.25 },
  grassPathPioneerHeightLoss: { minimum: 0, maximum: 0.7 },
  grassPathPioneerCoverage: { minimum: 0, maximum: 1 },
  grassDisturbanceHeightReduction: { minimum: 0, maximum: 0.8 },
  terrainVergeFleckStrength: { minimum: 0, maximum: 0.8 },
  terrainSoilHueWorldSize: { minimum: 6, maximum: 120 },
  terrainSoilHueStrength: { minimum: 0, maximum: 0.8 },
  terrainGroundFleckStrength: { minimum: 0, maximum: 0.4 },
  terrainHollowDarkening: { minimum: 0, maximum: 0.35 },
  terrainHollowMoisture: { minimum: 0, maximum: 0.3 },
  terrainMossStrength: { minimum: 0, maximum: 0.7 },
  terrainClumpContactAo: { minimum: 0, maximum: 0.45 },
  terrainClumpLitterStrength: { minimum: 0, maximum: 0.4 },
  grassNearNormalUpScale: { minimum: 0.4, maximum: 1 },
  grassCanopyDepthAo: { minimum: 0, maximum: 0.5 },
  grassClumpCoreAo: { minimum: 0, maximum: 0.3 },
  grassBladeTipDrift: { minimum: 0, maximum: 1.4 },
  grassBroadBladeShare: { minimum: 0, maximum: 0.25 },
  ...
  stoneFormationChance: { minimum: 0, maximum: 1 },
  stoneFormationGapRatioMin: { minimum: 0, maximum: 0.05 },
  stoneFormationGapRatioMax: { minimum: 0, maximum: 0.05 },
  stoneFormationGapMax: { minimum: 0.005, maximum: 0.08 },
  stoneFormationSupportHeightRatio: { minimum: 0.01, maximum: 0.25 },
  stoneFormationSupportHeightMax: { minimum: 0.01, maximum: 0.15 },
  ...
  stoneGrainNormalStrength: { minimum: 0, maximum: 0.5 },
